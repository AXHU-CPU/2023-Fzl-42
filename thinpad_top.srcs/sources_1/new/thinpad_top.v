...
// PLL分频示例
wire locked, clk_10M, clk_20M, clk_63M;
pll_example clock_gen 
 (
  // Clock in ports
  .clk_in1(clk_50M),  // 外部时钟输入
  // Clock out ports
  .clk_out1(clk_63M), // 时钟输出1，频率在IP配置界面中设�?
...
always@(posedge clk_63M or negedge locked) begin
    if(~locked) reset_of_clkout <= 1'b1;
    else        reset_of_clkout <= 1'b0;
end
/*
...
/* =========== Demo code end =========== */
    ...
    wire [3:0] base_ram_state;
    wire [2:0] ext_ram_state;
    wire [3:0] Serial_state;
    ...
    external_device DEVICE(
            ...
            // ����
            .ram_addr_i         (ram_addr),
            .ram_sel_i          (ram_sel_n),    // �͵�ƽ��Ч
            .ram_data_i         (ram_data_w),
            .ram_data_o         (ram_data_r),
            //����
            .rxd                (rxd),
            .txd                (txd),
            //BaseRAM�ź�
            ...
            .base_ram_be_n      (base_ram_be_n),    // �͵�ƽ��Ч
            .base_ram_ce_n      (base_ram_ce_n),    // �͵�ƽ��Ч
            .base_ram_oe_n      (base_ram_oe_n),    // �͵�ƽ��Ч
            .base_ram_we_n      (base_ram_we_n),    // �͵�ƽ��Ч
            //ExtRAM�ź�
            .ext_ram_data       (ext_ram_data),
            .ext_ram_addr       (ext_ram_addr),
            .ext_ram_be_n       (ext_ram_be_n),     // �͵�ƽ��Ч
            .ext_ram_ce_n       (ext_ram_ce_n),     // �͵�ƽ��Ч
            .ext_ram_oe_n       (ext_ram_oe_n),     // �͵�ƽ��Ч
            .ext_ram_we_n       (ext_ram_we_n)      // �͵�ƽ��Ч
            );
